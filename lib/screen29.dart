...
class Drag_DropState extends State<Drag_Drop> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            Text('Level29 :: Score ${score.length}/6', style: AppBarTextStyle),
    ...
    return DragTarget<String>(
      ...
      onAccept: (data) {
        setState(() {
          ...
          if (score.length == 6) {
            globals.twentynine = true;
            setlabel();
            Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(builder: (context) => Success(text: '30')),
